...
from dataset import get_dataset, ChineseDataset, QuickDrawDataset
...
parser.add_argument('-t', '--split', type=str, default='train', help='train/val/test')
...
for i, features in enumerate(features_list):
    ...
    datasets.append(Data(new_features, edge_list[i], y=targets_list[i], segmentation = segmentation_list[i]))
